...
// Fork overlay (personal/progress): when local AIFSProgress is
      // available, treat only user-completed lessons as open; static
      // 'complete' from data.js is ignored so the personal scoreboard
      // accurately reflects the learner's progress.
      var canOpen = (hasProgress ? (lessonPath && userComplete) : (l.status === 'complete' || userComplete)) && lessonPath;
